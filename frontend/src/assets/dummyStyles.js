...
export const footerStyles = {
  ...
  desktopEmailInput: "w-full pl-6 pr-[120px] py-4 text-base text-emerald-800 bg-white border-2 border-emerald-200 rounded-full focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:border-emerald-400 transition-all duration-300 transform shadow-lg placeholder-emerald-400",
  desktopSubscribeButton: "absolute right-2 top-1/2 -translate-y-1/2 bg-linear-to-r from-emerald-500 to-green-600 text-white px-3 py-1.5 rounded-full cursor-pointer transition-all duration-300 flex items-center shadow-lg hover:shadow-xl",
  desktopButtonIcon: "w-3.5 h-3.5 mr-1.5",
  desktopButtonText: "text-sm font-semibold",
